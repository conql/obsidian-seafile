import { arrayBufferToHex, ButtonComponent, Modal, Notice, Setting } from "obsidian";
...
export default class LoginModal extends Modal {
    ...
    onOpen(): void {
        ...
        contentEl.setText("Login to Seafile");
        ...
        new Setting(contentEl)
            .setName("Password")
            .addText(password => password.setPlaceholder("password").onChange(value => {
                this.password = value;
                if (this.account && this.password && this.deviceName) loginButton.setDisabled(false);
                else loginButton.setDisabled(true);
            }));
